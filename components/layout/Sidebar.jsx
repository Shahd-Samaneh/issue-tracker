...
import { LayoutDashboard, FileText, CirclePlus, } from "lucide-react";
const navItems = [
    {
        title: "Dashboard",
        href: "/dashboard",
...
export default function Sidebar({ isOpen, onClose }) {
    ...
    return <>
        ...
        <aside
            ...
            <h2 className="mb-6 text-lg font-semibold text-gray-800">Navigation</h2>
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        <Link className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-colors ${isActive
                            ...
                            : "text-gray-700 hover:bg-gray-100"}`} key={item.href} href={item.href}>
                            <Icon size={20} />
